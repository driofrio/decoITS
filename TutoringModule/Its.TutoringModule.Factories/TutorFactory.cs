...
namespace Its.TutoringModule.Factories
{
    public class TutorFactory
    {
        ...
        public ITutor CreateTutoringCoordinator(string domainKey, ITutorConfig config)
        {
            ...
            Tutor rTutor = new Tutor(ontologyPath, logsPath, expertConfPath, worldConfPath, worldControlDict, expertControl, studentControl, false);
            CollectiveModelTutor cmTutor = new CollectiveModelTutor(ontologyPath, logsPath, expertConfPath, worldConfPath, worldControlDict, expertControl, studentControl, false);
            TutoringCoordinator tc = new TutoringCoordinator(rTutor, cmTutor, ontologyPath, logsPath, expertConfPath, worldConfPath, worldControlDict, expertControl, studentControl);
